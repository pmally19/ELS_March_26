  ...
  const handleRefresh = (): void => {
    ...
    setTimeout(() => {
      const sampleData: TransactionRecord[] = [
        {
          id: 'ACTIVITYBASEDCOSTING-001',
          name: 'Transaction Record 001',
          status: 'active',
          date: new Date(),
          amount: 15000,
          description: 'Sample activitybasedcosting transaction',
          reference: 'REF-' + Date.now()
        },
        {
          id: 'ACTIVITYBASEDCOSTING-002',
          name: 'Transaction Record 002',
          status: 'pending',
          date: new Date(Date.now() - 24 * 60 * 60 * 1000),
          amount: 8500,
          description: 'Pending activitybasedcosting process',
          reference: 'REF-' + (Date.now() - 1000)
        },
        {
          id: 'ACTIVITYBASEDCOSTING-003',
          name: 'Transaction Record 003',
          status: 'completed',
          date: new Date(Date.now() - 48 * 60 * 60 * 1000),
          amount: 12750,
          description: 'Completed activitybasedcosting entry',
      ...
      <div className="container mx-auto p-6 space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">ActivityBasedCosting</h1>
              <p className="text-gray-600 mt-1">Manage activitybasedcosting transactions and processes</p>
            </div>
          </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle>ActivityBasedCosting Records</CardTitle>
            <CardDescription>
              Manage and view all activitybasedcosting transactions
            </CardDescription>
          </CardHeader>
          <CardContent>
            {loading ? (

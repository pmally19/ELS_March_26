  ...
  const handleRefresh = (): void => {
    ...
    setTimeout(() => {
      const sampleData: TransactionRecord[] = [
        {
          id: 'PRICINGMANAGEMENT-001',
          name: 'Transaction Record 001',
          status: 'active',
          date: new Date(),
          amount: 15000,
          description: 'Sample pricingmanagement transaction',
          reference: 'REF-' + Date.now()
        },
        {
          id: 'PRICINGMANAGEMENT-002',
          name: 'Transaction Record 002',
          status: 'pending',
          date: new Date(Date.now() - 24 * 60 * 60 * 1000),
          amount: 8500,
          description: 'Pending pricingmanagement process',
          reference: 'REF-' + (Date.now() - 1000)
        },
        {
          id: 'PRICINGMANAGEMENT-003',
          name: 'Transaction Record 003',
          status: 'completed',
          date: new Date(Date.now() - 48 * 60 * 60 * 1000),
          amount: 12750,
          description: 'Completed pricingmanagement entry',
      ...
      <div className="container mx-auto p-6 space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">PricingManagement</h1>
              <p className="text-gray-600 mt-1">Manage pricingmanagement transactions and processes</p>
            </div>
          </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle>PricingManagement Records</CardTitle>
            <CardDescription>
              Manage and view all pricingmanagement transactions
            </CardDescription>
          </CardHeader>
          <CardContent>
            {loading ? (

      ...
      const sampleData: TransactionRecord[] = [
        {
          ...
          date: new Date(),
          amount: 15000,
          description: 'Sample invoice transaction',
        ...
        },
        {
          ...
          amount: 8500,
          description: 'Pending invoice process',
        ...
        },
        {
          ...
          amount: 12750,
          description: 'Completed invoice entry',
      ...
      <div className="container mx-auto p-6 space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">Manage invoice transactions and processes</p>
            </div>
          </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Manage and view all invoice transactions
            </CardDescription>
          </CardHeader>
          <CardContent>
            {loading ? (

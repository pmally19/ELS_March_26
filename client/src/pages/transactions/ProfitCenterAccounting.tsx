...
export default function ProfitCenterAccounting() {
  ...
  const handleRefresh = (): void => {
    ...
    setTimeout(() => {
      const sampleData: TransactionRecord[] = [
        {
          id: 'PROFITCENTERACCOUNTING-001',
          name: 'Transaction Record 001',
          status: 'active',
          date: new Date(),
          amount: 15000,
          description: 'Sample profitcenteraccounting transaction',
          reference: 'REF-' + Date.now()
        },
        {
          id: 'PROFITCENTERACCOUNTING-002',
          name: 'Transaction Record 002',
          status: 'pending',
          date: new Date(Date.now() - 24 * 60 * 60 * 1000),
          amount: 8500,
          description: 'Pending profitcenteraccounting process',
          reference: 'REF-' + (Date.now() - 1000)
        },
        {
          id: 'PROFITCENTERACCOUNTING-003',
          name: 'Transaction Record 003',
          status: 'completed',
          date: new Date(Date.now() - 48 * 60 * 60 * 1000),
          amount: 12750,
          description: 'Completed profitcenteraccounting entry',
      ...
      <div className="container mx-auto p-6 space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">ProfitCenterAccounting</h1>
              <p className="text-gray-600 mt-1">Manage profitcenteraccounting transactions and processes</p>
            </div>
          </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle>ProfitCenterAccounting Records</CardTitle>
            <CardDescription>
              Manage and view all profitcenteraccounting transactions
            </CardDescription>
          </CardHeader>
          <CardContent>
            {loading ? (

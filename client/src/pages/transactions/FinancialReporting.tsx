      ...
      const sampleData: TransactionRecord[] = [
        {
          ...
          date: new Date(),
          amount: 15000,
          description: 'Sample financialreporting transaction',
        ...
        },
        {
          ...
          amount: 8500,
          description: 'Pending financialreporting process',
        ...
        },
        {
          ...
          amount: 12750,
          description: 'Completed financialreporting entry',
      ...
      <div className="container mx-auto p-6 space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">FinancialReporting</h1>
              <p className="text-gray-600 mt-1">Manage financialreporting transactions and processes</p>
            </div>
          </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle>FinancialReporting Records</CardTitle>
            <CardDescription>
              Manage and view all financialreporting transactions
            </CardDescription>
          </CardHeader>
          <CardContent>
            {loading ? (

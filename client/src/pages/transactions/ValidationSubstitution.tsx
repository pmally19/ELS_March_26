...
export default function ValidationSubstitution() {
  ...
  const handleRefresh = (): void => {
    ...
    setTimeout(() => {
      const sampleData: TransactionRecord[] = [
        {
          id: 'VALIDATIONSUBSTITUTION-001',
          name: 'Transaction Record 001',
          status: 'active',
          date: new Date(),
          amount: 15000,
          description: 'Sample validationsubstitution transaction',
          reference: 'REF-' + Date.now()
        },
        {
          id: 'VALIDATIONSUBSTITUTION-002',
          name: 'Transaction Record 002',
          status: 'pending',
          date: new Date(Date.now() - 24 * 60 * 60 * 1000),
          amount: 8500,
          description: 'Pending validationsubstitution process',
          reference: 'REF-' + (Date.now() - 1000)
        },
        {
          id: 'VALIDATIONSUBSTITUTION-003',
          name: 'Transaction Record 003',
          status: 'completed',
          date: new Date(Date.now() - 48 * 60 * 60 * 1000),
          amount: 12750,
          description: 'Completed validationsubstitution entry',
      ...
      <div className="container mx-auto p-6 space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">ValidationSubstitution</h1>
              <p className="text-gray-600 mt-1">Manage validationsubstitution transactions and processes</p>
            </div>
          </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle>ValidationSubstitution Records</CardTitle>
            <CardDescription>
              Manage and view all validationsubstitution transactions
            </CardDescription>
          </CardHeader>
          <CardContent>
            {loading ? (

...
export default function Customer() {
  ...
  // Update local state whenever customers data changes
  useEffect(() => {
  ...
  const addCustomerMutation = useMutation({
    ...
    onSuccess: async (response) => {
      // Directly add the new customer to our local state
      const newCustomer = response as Customer;
      ...
      if (newCustomer && newCustomer.id) {
        ...
        setViewingCustomerDetails(newCustomer);

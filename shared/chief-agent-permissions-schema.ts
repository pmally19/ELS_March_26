...
export const chiefAgentPermissions = pgTable("chief_agent_permissions", {
...
export const chiefAgentActionLog = pgTable("chief_agent_action_log", {
...
// Schema exports
export const insertChiefAgentPermissionsSchema = createInsertSchema(chiefAgentPermissions);
export const insertChiefAgentActionLogSchema = createInsertSchema(chiefAgentActionLog);

export type ChiefAgentPermissions = typeof chiefAgentPermissions.$inferSelect;
export type InsertChiefAgentPermissions = z.infer<typeof insertChiefAgentPermissionsSchema>;

export type ChiefAgentActionLog = typeof chiefAgentActionLog.$inferSelect;
export type InsertChiefAgentActionLog = z.infer<typeof insertChiefAgentActionLogSchema>;
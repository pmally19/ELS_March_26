...
export var salesOrders = pgTable("sales_orders", {
...
export var inventoryReservations = pgTable("inventory_reservations", {
    id: serial("id").primaryKey(),
    salesOrderId: integer("sales_order_id").notNull(),
...
// Invoice Line Items
export var invoiceItems = pgTable("invoice_items", {
    id: serial("id").primaryKey(),
...
export var orderToCAshProcessLog = pgTable("order_to_cash_process_log", {
    id: serial("id").primaryKey(),
    salesOrderId: integer("sales_order_id").notNull(),
...
// Relations
export var salesOrdersRelations = relations(salesOrders, function (_a) {
...
// Zod Schemas
export var insertSalesOrderSchema = createInsertSchema(salesOrders).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
    lastStatusChange: true,
});
export var insertSalesOrderItemSchema = createInsertSchema(salesOrderItems).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertDeliveryDocumentSchema = createInsertSchema(deliveryDocuments).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertCustomerInvoiceSchema = createInsertSchema(customerInvoices).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
...
export var quotationItems = pgTable("quotation_items", {
    id: serial("id").primaryKey(),
    quotationId: integer("quotation_id").notNull().references(function () { return quotations.id; }),
    lineNumber: integer("line_number").notNull(),
...
export var quotationItemsRelations = relations(quotationItems, function (_a) {
    var one = _a.one;
    return ({
...
export var insertQuotationSchema = createInsertSchema(quotations).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertQuotationItemSchema = createInsertSchema(quotationItems).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});

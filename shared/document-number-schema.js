 ...
 */
export var documentNumberSequences = pgTable("document_number_sequences", {
...
export var insertDocumentNumberSequenceSchema = createInsertSchema(documentNumberSequences).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});

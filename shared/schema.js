import { pgTable, text, serial, integer, boolean, doublePrecision, timestamp, jsonb, varchar, uuid, decimal, date } from "drizzle-orm/pg-core";
...
export var currencies = pgTable("currencies", {
...
export var exchangeRates = pgTable("exchange_rates", {
    id: serial("id").primaryKey(),
    fromCurrencyId: integer("from_currency_id").notNull().references(function () { return currencies.id; }),
    toCurrencyId: integer("to_currency_id").notNull().references(function () { return currencies.id; }),
...
export var currencyRevaluations = pgTable("currency_revaluations", {
    id: serial("id").primaryKey(),
    revaluationDate: date("revaluation_date").notNull(),
    currencyId: integer("currency_id").notNull().references(function () { return currencies.id; }),
...
// Currency Relations
export var currenciesRelations = relations(currencies, function (_a) {
    var many = _a.many;
    return ({
...
export var exchangeRatesRelations = relations(exchangeRates, function (_a) {
    var one = _a.one;
    return ({
...
export var currencyRevaluationsRelations = relations(currencyRevaluations, function (_a) {
    var one = _a.one;
    return ({
...
export var insertCurrencySchema = createInsertSchema(currencies);
export var insertExchangeRateSchema = createInsertSchema(exchangeRates);
export var insertCurrencyRevaluationSchema = createInsertSchema(currencyRevaluations);
// SAP Transaction Tiles Tables with Complete Data Integrity
// Document Number Ranges - SAP SNRO
export var documentNumberRanges = pgTable("document_number_ranges", {
    id: serial("id").primaryKey(),
...
export var documentPostingSystem = pgTable("document_posting_system", {
    id: serial("id").primaryKey(),
...
export var automaticClearing = pgTable("automatic_clearing", {
    id: serial("id").primaryKey(),
...
export var assetAccounting = pgTable("asset_accounting", {
    id: serial("id").primaryKey(),
...
export var bankStatementProcessing = pgTable("bank_statement_processing", {
    id: serial("id").primaryKey(),
...
export var paymentProcessing = pgTable("payment_processing", {
    id: serial("id").primaryKey(),
...
export var insertDocumentNumberRangeSchema = createInsertSchema(documentNumberRanges);
export var insertDocumentPostingSystemSchema = createInsertSchema(documentPostingSystem);
export var insertAutomaticClearingSchema = createInsertSchema(automaticClearing);
export var insertAssetAccountingSchema = createInsertSchema(assetAccounting);
export var insertBankStatementProcessingSchema = createInsertSchema(bankStatementProcessing);
export var insertPaymentProcessingSchema = createInsertSchema(paymentProcessing);
// Bank Accounts for Cash Management
export var bankAccounts = pgTable("bank_accounts", {
    id: serial("id").primaryKey(),
...
export var bankTransactions = pgTable("bank_transactions", {
    id: serial("id").primaryKey(),
    bankAccountId: integer("bank_account_id").notNull().references(function () { return bankAccounts.id; }),
...
export var cashPositions = pgTable("cash_positions", {
    id: serial("id").primaryKey(),
    companyCodeId: integer("company_code_id").notNull(),
...
export var taxJurisdictions = pgTable("tax_jurisdictions", {
    id: serial("id").primaryKey(),
...
export var taxCodes = pgTable("tax_codes", {
    id: serial("id").primaryKey(),
    ...
    taxJurisdictionId: integer("tax_jurisdiction_id").references(function () { return taxJurisdictions.id; }),
...
export var taxTransactions = pgTable("tax_transactions", {
    id: serial("id").primaryKey(),
    documentNumber: varchar("document_number", { length: 20 }).notNull(),
    postingDate: date("posting_date").notNull(),
    taxCodeId: integer("tax_code_id").notNull().references(function () { return taxCodes.id; }),
...
export var vendorInvoices = pgTable("vendor_invoices", {
    id: serial("id").primaryKey(),
...
export var customerInvoices = pgTable("customer_invoices", {
    id: serial("id").primaryKey(),
...
export var customers = pgTable("erp_customers", {
    id: serial("id").primaryKey(),
...
export var customerRelations = relations(customers, function (_a) {
...
export var categoryRelations = relations(categories, function (_a) {
    var one = _a.one;
    return ({
        user: one(users, {
...
// User Workspaces
export var userWorkspaces = pgTable("user_workspaces", {
    id: serial("id").primaryKey(),
    name: text("name").notNull(),
    description: text("description"),
...
export var userWorkspaceRelations = relations(userWorkspaces, function (_a) {
    var one = _a.one;
    return ({
        user: one(users, {
...
export var userRoles = pgTable("user_roles", {
    id: serial("id").primaryKey(),
    userId: integer("user_id").references(function () { return users.id; }).notNull(),
    ...
    isActive: boolean("is_active").default(true),
    assignedBy: integer("assigned_by").references(function () { return users.id; }),
    createdAt: timestamp("created_at").defaultNow().notNull(),
    updatedAt: timestamp("updated_at").defaultNow().notNull(),
});
export var userRoleRelations = relations(userRoles, function (_a) {
    var one = _a.one;
    return ({
        user: one(users, {
...
export var tileRegistry = pgTable("tile_registry", {
    id: serial("id").primaryKey(),
...
export var tileNamingDocumentation = pgTable("tile_naming_documentation", {
    id: serial("id").primaryKey(),
...
export var workspaceTileAssignments = pgTable("workspace_tile_assignments", {
    id: serial("id").primaryKey(),
    workspaceId: integer("workspace_id").references(function () { return userWorkspaces.id; }).notNull(),
    tileNumber: text("tile_number").references(function () { return tileRegistry.tileNumber; }).notNull(),
    isVisible: boolean("is_visible").default(true),
    isFavorite: boolean("is_favorite").default(false),
    customPosition: integer("custom_position"), // User-defined ordering
    addedAt: timestamp("added_at").defaultNow().notNull(),
});
export var tileRegistryRelations = relations(tileRegistry, function (_a) {
    var many = _a.many;
    return ({
        workspaceAssignments: many(workspaceTileAssignments),
    });
});
export var workspaceTileAssignmentRelations = relations(workspaceTileAssignments, function (_a) {
    var one = _a.one;
    return ({
...
export var materials = pgTable("materials", {
    id: serial("id").primaryKey(),
...
export var plants = pgTable("plants", {
    id: serial("id").primaryKey(),
...
export var orderRelations = relations(orders, function (_a) {
    var one = _a.one, many = _a.many;
    return ({
...
// Order Items schema
export var orderItems = pgTable("order_items", {
    id: serial("id").primaryKey(),
    orderId: integer("order_id").references(function () { return orders.id; }),
    materialId: integer("material_id").references(function () { return materials.id; }), // New
...
export var orderItemRelations = relations(orderItems, function (_a) {
    var one = _a.one;
    return ({
        order: one(orders, {
...
export var invoiceRelations = relations(invoices, function (_a) {
    var one = _a.one;
    return ({
        order: one(orders, {
...
export var quotationRelations = relations(quotations, function (_a) {
    var one = _a.one, many = _a.many;
    return ({
        customer: one(customers, {
...
export var quotationItems = pgTable("quotation_items", {
    id: serial("id").primaryKey(),
    quotationId: integer("quotation_id").references(function () { return quotations.id; }).notNull(),
...
export var quotationItemRelations = relations(quotationItems, function (_a) {
    var one = _a.one;
    return ({
...
export var insertQuotationSchema = createInsertSchema(quotations).omit({ id: true, createdAt: true, updatedAt: true });
export var insertQuotationItemSchema = createInsertSchema(quotationItems).omit({ id: true, createdAt: true, updatedAt: true });
// Expense schema
...
export var expenseRelations = relations(expenses, function (_a) {
    var one = _a.one;
    return ({
        user: one(users, {
...
// Stock movements schema
export var stockMovements = pgTable("stock_movements", {
    id: serial("id").primaryKey(),
    materialId: integer("material_id").references(function () { return materials.id; }),
...
export var stockMovementRelations = relations(stockMovements, function (_a) {
    var one = _a.one;
    return ({
        material: one(materials, {
...
export var insertCategorySchema = createInsertSchema(categories).omit({ id: true, createdAt: true, updatedAt: true });
export var insertOrderSchema = createInsertSchema(orders).omit({ id: true, createdAt: true, updatedAt: true });
export var insertOrderItemSchema = createInsertSchema(orderItems).omit({ id: true, createdAt: true, updatedAt: true });
export var insertInvoiceSchema = createInsertSchema(invoices).omit({ id: true, createdAt: true, updatedAt: true });
export var insertExpenseSchema = createInsertSchema(expenses).omit({ id: true, createdAt: true, updatedAt: true });
export var insertStockMovementSchema = createInsertSchema(stockMovements).omit({ id: true, createdAt: true });
export var insertMaterialSchema = createInsertSchema(materials).omit({ id: true, createdAt: true, updatedAt: true });
// Chart of Accounts schema
export var chartOfAccounts = pgTable("chart_of_accounts", {
    id: serial("id").primaryKey(),
...
export var fiscalYearVariants = pgTable("fiscal_year_variants", {
    id: serial("id").primaryKey(),
...
export var glAccounts = pgTable("gl_accounts", {
    id: serial("id").primaryKey(),
    // Section 1: Basic Data
    accountNumber: text("account_number").notNull().unique(),
    accountName: text("account_name").notNull(),
    longText: text("long_text"), // Detailed description
    chartOfAccountsId: integer("chart_of_accounts_id").references(function () { return chartOfAccounts.id; }),
    ...
    companyCodeId: integer("company_code_id").references(function () { return companyCodes.id; }),
...
// Cost Centers schema
export var costCenters = pgTable("cost_centers", {
    id: serial("id").primaryKey(),
    code: text("code").notNull().unique(),
    name: text("name").notNull(),
    description: text("description"),
...
export var profitCenters = pgTable("profit_centers", {
    id: serial("id").primaryKey(),
    code: text("code").notNull().unique(),
    name: text("name").notNull(),
    description: text("description"),
...
export var glEntries = pgTable("gl_entries", {
    id: serial("id").primaryKey(),
    documentNumber: varchar("document_number", { length: 50 }).notNull(),
    glAccountId: integer("gl_account_id").references(function () { return glAccounts.id; }),
    amount: decimal("amount", { precision: 15, scale: 2 }).notNull(),
    ...
    costCenterId: integer("cost_center_id").references(function () { return costCenters.id; }),
    profitCenterId: integer("profit_center_id").references(function () { return profitCenters.id; }),
...
export var companyCodeChartAssignments = pgTable("company_code_chart_assignments", {
    id: serial("id").primaryKey(),
    companyCodeId: integer("company_code_id").references(function () { return companyCodes.id; }),
    chartOfAccountsId: integer("chart_of_accounts_id").references(function () { return chartOfAccounts.id; }),
    fiscalYearVariantId: integer("fiscal_year_variant_id").references(function () { return fiscalYearVariants.id; }),
    assignedDate: timestamp("assigned_date").defaultNow().notNull(),
    isActive: boolean("is_active").default(true).notNull(),
    createdAt: timestamp("created_at").defaultNow().notNull(),
});
// Period End Closing schema - tracks period closing processes
export var periodEndClosing = pgTable("period_end_closing", {
    id: serial("id").primaryKey(),
...
// Company Codes schema (ensure we have the reference)
export var companyCodes = pgTable("company_codes", {
    id: serial("id").primaryKey(),
    code: text("code").notNull().unique(),
    name: text("name").notNull(),
    description: text("description"),
...
export var regions = pgTable("regions", {
    id: serial("id").primaryKey(),
...
export var insertRegionSchema = createInsertSchema(regions).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
// Countries - Geographic master data
export var countries = pgTable("countries", {
    id: serial("id").primaryKey(),
    code: varchar("code", { length: 2 }).notNull().unique(),
    name: varchar("name", { length: 100 }).notNull(),
    description: text("description"),
    regionId: integer("region_id").references(function () { return regions.id; }),
...
export var insertCountrySchema = createInsertSchema(countries).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
// States - Geographic subdivisions of countries
export var states = pgTable("states", {
    id: serial("id").primaryKey(),
...
export var insertStateSchema = createInsertSchema(states).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
// Relations
export var chartOfAccountsRelations = relations(chartOfAccounts, function (_a) {
    var many = _a.many;
    return ({
...
export var fiscalYearVariantRelations = relations(fiscalYearVariants, function (_a) {
    var many = _a.many;
    return ({
        companyAssignments: many(companyCodeChartAssignments),
    });
});
export var glAccountRelations = relations(glAccounts, function (_a) {
    var one = _a.one;
    return ({
...
export var costCenterRelations = relations(costCenters, function (_a) {
    var one = _a.one;
    return ({
...
export var profitCenterRelations = relations(profitCenters, function (_a) {
    var one = _a.one;
    return ({
        companyCode: one(companyCodes, {
...
export var companyCodeRelations = relations(companyCodes, function (_a) {
    var many = _a.many;
    return ({
...
export var companyCodeChartAssignmentRelations = relations(companyCodeChartAssignments, function (_a) {
    var one = _a.one;
    return ({
        companyCode: one(companyCodes, {
...
export var insertChartOfAccountsSchema = createInsertSchema(chartOfAccounts).omit({ id: true, createdAt: true, updatedAt: true });
export var insertFiscalYearVariantSchema = createInsertSchema(fiscalYearVariants).omit({ id: true, created_at: true, updated_at: true });
export var updateFiscalYearVariantSchema = insertFiscalYearVariantSchema.partial();
export var insertGlAccountSchema = createInsertSchema(glAccounts).omit({ id: true, createdAt: true, updatedAt: true });
export var insertGlEntrySchema = createInsertSchema(glEntries).omit({ id: true, createdAt: true });
export var insertCostCenterSchema = createInsertSchema(costCenters).omit({ id: true, createdAt: true, updatedAt: true });
export var insertProfitCenterSchema = createInsertSchema(profitCenters).omit({ id: true, createdAt: true, updatedAt: true });
export var insertCompanyCodeChartAssignmentSchema = createInsertSchema(companyCodeChartAssignments).omit({ id: true, createdAt: true });
// Chief Agent System Tables
export var chiefAgentChangeRequests = pgTable("chief_agent_change_requests", {
...
export var chiefAgentSystemMonitoring = pgTable("chief_agent_system_monitoring", {
    id: text("id").primaryKey(),
...
export var chiefAgentHumanInteractions = pgTable("chief_agent_human_interactions", {
    id: text("id").primaryKey(),
...
export var chiefAgentDecisionAudit = pgTable("chief_agent_decision_audit", {
    id: text("id").primaryKey(),
    changeRequestId: text("change_request_id").notNull(),
...
export var insertChiefAgentChangeRequestSchema = createInsertSchema(chiefAgentChangeRequests);
export var insertChiefAgentSystemMonitoringSchema = createInsertSchema(chiefAgentSystemMonitoring);
export var insertChiefAgentHumanInteractionSchema = createInsertSchema(chiefAgentHumanInteractions);
export var insertChiefAgentDecisionAuditSchema = createInsertSchema(chiefAgentDecisionAudit);
...
export var rookieAgentSessions = pgTable("rookie_agent_sessions", {
...
export var rookieAgentDataEntries = pgTable("rookie_agent_data_entries", {
    id: uuid("id").primaryKey().defaultRandom(),
    sessionId: uuid("session_id").references(function () { return rookieAgentSessions.id; }),
...
export var rookieAgentTraining = pgTable("rookie_agent_training", {
    id: uuid("id").primaryKey().defaultRandom(),
    businessDomain: varchar("business_domain").notNull(),
...
export var rookieAgentQualityChecks = pgTable("rookie_agent_quality_checks", {
    id: uuid("id").primaryKey().defaultRandom(),
    businessDomain: varchar("business_domain").notNull(),
...
export var insertRookieAgentSessionSchema = createInsertSchema(rookieAgentSessions);
export var insertRookieAgentDataEntrySchema = createInsertSchema(rookieAgentDataEntries);
export var insertRookieAgentTrainingSchema = createInsertSchema(rookieAgentTraining);
export var insertRookieAgentQualityCheckSchema = createInsertSchema(rookieAgentQualityChecks);
// Cash Management insert schemas and types
export var insertBankAccountSchema = createInsertSchema(bankAccounts).omit({ id: true, createdAt: true, updatedAt: true });
export var insertBankTransactionSchema = createInsertSchema(bankTransactions).omit({ id: true, createdAt: true, updatedAt: true });
export var insertCashPositionSchema = createInsertSchema(cashPositions).omit({ id: true, createdAt: true });
export var insertTaxJurisdictionSchema = createInsertSchema(taxJurisdictions).omit({ id: true, createdAt: true });
export var insertTaxCodeSchema = createInsertSchema(taxCodes).omit({ id: true, createdAt: true });
export var insertTaxTransactionSchema = createInsertSchema(taxTransactions).omit({ id: true, createdAt: true });
export var insertVendorInvoiceSchema = createInsertSchema(vendorInvoices).omit({ id: true, createdAt: true, updatedAt: true });
export var insertCustomerInvoiceSchema = createInsertSchema(customerInvoices).omit({ id: true, createdAt: true, updatedAt: true });
// Customer-Bank Relationship schema
export var customerBankRelationships = pgTable("customer_bank_relationships", {
    id: serial("id").primaryKey(),
    customerId: integer("customer_id").notNull().references(function () { return customers.id; }),
    bankAccountId: integer("bank_account_id").notNull().references(function () { return bankAccounts.id; }),
...
export var paymentTransactions = pgTable("payment_transactions", {
    id: serial("id").primaryKey(),
    customerPaymentId: integer("customer_payment_id").notNull().references(function () { return customerPayments.id; }),
    bankAccountId: integer("bank_account_id").notNull().references(function () { return bankAccounts.id; }),
    bankTransactionId: integer("bank_transaction_id").references(function () { return bankTransactions.id; }),
    arInvoiceId: integer("ar_invoice_id").references(function () { return accountsReceivable.id; }),
...
export var customerPayments = pgTable("customer_payments", {
    id: serial("id").primaryKey(),
...
export var accountsReceivable = pgTable("accounts_receivable", {
    id: serial("id").primaryKey(),
    customerId: integer("customer_id").notNull().references(function () { return customers.id; }),
    invoiceNumber: varchar("invoice_number", { length: 50 }).notNull(),
    invoiceDate: date("invoice_date").notNull(),
...
export var vendorPayments = pgTable("vendor_payments", {
    id: serial("id").primaryKey(),
...
// Insert schemas for new tables
export var insertCustomerBankRelationshipSchema = createInsertSchema(customerBankRelationships).omit({ id: true, createdAt: true, updatedAt: true });
export var insertPaymentTransactionSchema = createInsertSchema(paymentTransactions).omit({ id: true, createdAt: true, updatedAt: true });
export var insertCustomerPaymentSchema = createInsertSchema(customerPayments).omit({ id: true, createdAt: true, updatedAt: true });
export var insertAccountsReceivableSchema = createInsertSchema(accountsReceivable).omit({ id: true, createdAt: true, updatedAt: true });
export var insertVendorPaymentSchema = createInsertSchema(vendorPayments).omit({ id: true, createdAt: true, updatedAt: true });
...
export var globalCompanyCodes = pgTable("global_company_codes", {
    id: serial("id").primaryKey(),
...
export var vatRegistrationNumbers = pgTable("vat_registration_numbers", {
    id: serial("id").primaryKey(),
...
export var supplyTypes = pgTable("supply_types", {
    id: serial("id").primaryKey(),
    code: varchar("code", { length: 10 }).notNull().unique(),
    name: varchar("name", { length: 100 }).notNull(),
...
export var purchasingGroups = pgTable("purchasing_groups", {
    id: serial("id").primaryKey(),
    code: varchar("code", { length: 10 }).notNull().unique(),
    description: varchar("description", { length: 100 }).notNull(),
...
export var vendorGroups = pgTable("vendor_groups", {
    id: serial("id").primaryKey(),
    code: varchar("code", { length: 10 }).notNull().unique(),
    description: varchar("description", { length: 100 }).notNull(),
...
export var customerGroups = pgTable("customer_groups", {
    id: serial("id").primaryKey(),
    code: varchar("code", { length: 10 }).notNull().unique(),
    name: varchar("name", { length: 100 }).notNull(),
    description: text("description"),
...
export var customerTypes = pgTable("customer_types", {
    id: serial("id").primaryKey(),
    code: varchar("code", { length: 10 }).notNull().unique(),
    name: varchar("name", { length: 100 }).notNull(),
    description: text("description"),
...
export var materialGroups = pgTable("material_groups", {
    id: serial("id").primaryKey(),
    code: varchar("code", { length: 10 }).notNull().unique(),
    description: varchar("description", { length: 100 }).notNull(),
...
export var materialTypes = pgTable("material_types", {
    id: serial("id").primaryKey(),
    code: varchar("code", { length: 10 }).notNull().unique(),
    description: varchar("description", { length: 100 }).notNull(),
...
export var industrySectors = pgTable("industry_sectors", {
    id: serial("id").primaryKey(),
    code: varchar("code", { length: 10 }).notNull().unique(),
    description: varchar("description", { length: 100 }).notNull(),
...
export var distributionChannels = pgTable("distribution_channels", {
    id: serial("id").primaryKey(),
    code: varchar("code", { length: 10 }).notNull().unique(),
...
export var divisions = pgTable("divisions", {
    id: serial("id").primaryKey(),
    code: varchar("code", { length: 10 }).notNull().unique(),
    description: varchar("description", { length: 100 }).notNull(),
...
export var plantCategories = pgTable("plant_categories", {
    id: serial("id").primaryKey(),
    code: varchar("code", { length: 10 }).notNull().unique(),
    description: varchar("description", { length: 100 }).notNull(),
...
export var workCenterCategories = pgTable("work_center_categories", {
    id: serial("id").primaryKey(),
    code: varchar("code", { length: 10 }).notNull().unique(),
    description: varchar("description", { length: 100 }).notNull(),
...
export var paymentMethods = pgTable("payment_methods", {
    id: serial("id").primaryKey(),
    code: varchar("code", { length: 10 }).notNull().unique(),
    description: varchar("description", { length: 100 }).notNull(),
    companyCodeId: integer("company_code_id").references(function () { return companyCodes.id; }),
...
export var businessAreas = pgTable("business_areas", {
    id: serial("id").primaryKey(),
    code: varchar("code", { length: 10 }).notNull().unique(),
    description: varchar("description", { length: 100 }).notNull(),
    companyCodeId: integer("company_code_id").references(function () { return companyCodes.id; }, { onDelete: "set null" }),
...
export var authorizationGroups = pgTable("authorization_groups", {
    id: serial("id").primaryKey(),
    code: varchar("code", { length: 10 }).notNull().unique(),
    description: varchar("description", { length: 100 }).notNull(),
...
export var insertSupplyTypeSchema = createInsertSchema(supplyTypes).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
// Purchasing Groups Insert Schema
export var insertPurchasingGroupSchema = createInsertSchema(purchasingGroups).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
// Vendor Groups Insert Schema
export var insertVendorGroupSchema = createInsertSchema(vendorGroups).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
// Customer Groups Insert Schema
export var insertCustomerGroupSchema = createInsertSchema(customerGroups).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
// Customer Types Insert Schema
export var insertCustomerTypeSchema = createInsertSchema(customerTypes).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
// Material Groups Insert Schema
export var insertMaterialGroupSchema = createInsertSchema(materialGroups).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
// Material Types Insert Schema
export var insertMaterialTypeSchema = createInsertSchema(materialTypes).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
// Industry Sectors Insert Schema
export var insertIndustrySectorSchema = createInsertSchema(industrySectors).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
// Distribution Channels Insert Schema
export var insertDistributionChannelSchema = z.object({
...
export var insertDivisionSchema = createInsertSchema(divisions).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
// Plant Categories Insert Schema
export var insertPlantCategorySchema = createInsertSchema(plantCategories).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
// Work Center Categories Insert Schema
export var insertWorkCenterCategorySchema = createInsertSchema(workCenterCategories).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
// Payment Methods Insert Schema
export var insertPaymentMethodSchema = createInsertSchema(paymentMethods).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
// Business Areas Insert Schema
export var insertBusinessAreaSchema = createInsertSchema(businessAreas).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
// Authorization Groups Insert Schema
export var insertAuthorizationGroupSchema = createInsertSchema(authorizationGroups).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
...
export var materialCosting = pgTable("material_costing", {
    id: serial("id").primaryKey(),
...
export var manufacturingChartOfAccounts = pgTable("manufacturing_chart_of_accounts", {
    id: serial("id").primaryKey(),
...
// GL Account Balances
export var glAccountBalances = pgTable("gl_account_balances", {
    id: serial("id").primaryKey(),
...
export var workCenterCostRates = pgTable("work_center_cost_rates", {
    id: serial("id").primaryKey(),
...
export var costCenterMaster = pgTable("cost_center_master", {
    id: serial("id").primaryKey(),
...
export var productionOrderCosting = pgTable("production_order_costing", {
    id: serial("id").primaryKey(),
...
export var manufacturingInventoryValuation = pgTable("manufacturing_inventory_valuation", {
    id: serial("id").primaryKey(),
    materialCode: varchar("material_code", { length: 18 }).notNull(),
    plantCode: varchar("plant_code", { length: 4 }).notNull(),
...
export var glPostingDocuments = pgTable("gl_posting_documents", {
    id: serial("id").primaryKey(),
    documentNumber: varchar("document_number", { length: 20 }).notNull().unique(),
...
export var glPostingLineItems = pgTable("gl_posting_line_items", {
    id: serial("id").primaryKey(),
    documentNumber: varchar("document_number", { length: 20 }).notNull(),
...
export var insertMaterialCostingSchema = createInsertSchema(materialCosting);
export var insertManufacturingChartOfAccountsSchema = createInsertSchema(manufacturingChartOfAccounts);
export var insertGlAccountBalancesSchema = createInsertSchema(glAccountBalances);
export var insertWorkCenterCostRatesSchema = createInsertSchema(workCenterCostRates);
export var insertCostCenterMasterSchema = createInsertSchema(costCenterMaster);
export var insertProductionOrderCostingSchema = createInsertSchema(productionOrderCosting);
export var insertManufacturingInventoryValuationSchema = createInsertSchema(manufacturingInventoryValuation);
export var insertGlPostingDocumentsSchema = createInsertSchema(glPostingDocuments);
export var insertGlPostingLineItemsSchema = createInsertSchema(glPostingLineItems);
// Tax Configuration table - Tax setup and rules
export var taxConfiguration = pgTable("tax_configuration", {
    id: serial("id").primaryKey(),
    code: varchar("code", { length: 10 }).notNull().unique(),
    description: varchar("description", { length: 100 }).notNull(),
...
export var toleranceGroups = pgTable("tolerance_groups", {
    id: serial("id").primaryKey(),
    code: varchar("code", { length: 10 }).notNull().unique(),
    description: varchar("description", { length: 100 }).notNull(),
...
export var insertTaxConfigurationSchema = createInsertSchema(taxConfiguration).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
// Tolerance Groups Insert Schema
export var insertToleranceGroupSchema = createInsertSchema(toleranceGroups).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
...
// ==========================================================
export var taxProfiles = pgTable("tax_profiles", {
    id: serial("id").primaryKey(),
...
export var taxRules = pgTable("tax_rules", {
    id: serial("id").primaryKey(),
    profileId: integer("profile_id").notNull().references(function () { return taxProfiles.id; }),
...
export var insertTaxProfileSchema = createInsertSchema(taxProfiles).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertTaxRuleSchema = createInsertSchema(taxRules).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
...
export var mrpControllers = pgTable("mrp_controllers", {
    id: serial("id").primaryKey(),
...
export var mrpElements = pgTable("mrp_elements", {
    id: serial("id").primaryKey(),
    materialId: integer("material_id").references(function () { return materials.id; }).notNull(),
    plantId: integer("plant_id").references(function () { return plants.id; }).notNull(),
    ...
    mrpController: varchar("mrp_controller", { length: 3 }).references(function () { return mrpControllers.controllerCode; }),
...
export var materialMrpData = pgTable("material_mrp_data", {
    id: serial("id").primaryKey(),
    materialId: integer("material_id").references(function () { return materials.id; }).notNull(),
    plantId: integer("plant_id").references(function () { return plants.id; }).notNull(),
...
// MRP Run History
export var mrpRunHistory = pgTable("mrp_run_history", {
    id: serial("id").primaryKey(),
    ...
    plantId: integer("plant_id").references(function () { return plants.id; }),
...
export var costComponentStructure = pgTable("cost_component_structure", {
    id: serial("id").primaryKey(),
    materialId: integer("material_id").references(function () { return materials.id; }).notNull(),
    plantId: integer("plant_id").references(function () { return plants.id; }).notNull(),
...
export var manufacturingVariances = pgTable("manufacturing_variances", {
    id: serial("id").primaryKey(),
...
export var inventoryValuation = pgTable("inventory_valuation", {
    id: serial("id").primaryKey(),
    materialId: integer("material_id").references(function () { return materials.id; }).notNull(),
    plantId: integer("plant_id").references(function () { return plants.id; }).notNull(),
    storageLocation: varchar("storage_location", { length: 4 }),
...
export var mrpAccountDetermination = pgTable("mrp_account_determination", {
    id: serial("id").primaryKey(),
...
export var mrpControllerRelations = relations(mrpControllers, function (_a) {
    var many = _a.many;
    return ({
...
export var mrpElementRelations = relations(mrpElements, function (_a) {
    var one = _a.one;
    return ({
        material: one(materials, {
...
export var materialMrpDataRelations = relations(materialMrpData, function (_a) {
    var one = _a.one;
    return ({
        material: one(materials, {
...
export var manufacturingVarianceRelations = relations(manufacturingVariances, function (_a) {
    var one = _a.one;
    return ({
        material: one(materials, {
...
export var inventoryValuationRelations = relations(inventoryValuation, function (_a) {
    var one = _a.one;
    return ({
        material: one(materials, {
...
export var insertMrpControllerSchema = createInsertSchema(mrpControllers).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertMrpElementSchema = createInsertSchema(mrpElements).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertMaterialMrpDataSchema = createInsertSchema(materialMrpData).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertCostComponentStructureSchema = createInsertSchema(costComponentStructure).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertManufacturingVarianceSchema = createInsertSchema(manufacturingVariances).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertInventoryValuationSchema = createInsertSchema(inventoryValuation).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertMrpAccountDeterminationSchema = createInsertSchema(mrpAccountDetermination).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
// Currency Denomination Master Data
export var currencyDenomination = pgTable("currency_denomination", {
    id: serial("id").primaryKey(),
    code: varchar("code", { length: 10 }).notNull().unique(),
    description: text("description").notNull(),
    currency: varchar("currency", { length: 3 }).notNull(),
...
export var exchangeRateType = pgTable("exchange_rate_type", {
    id: serial("id").primaryKey(),
    code: varchar("code", { length: 10 }).notNull().unique(),
    description: text("description").notNull(),
...
export var insertCurrencyDenominationSchema = createInsertSchema(currencyDenomination).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
// Exchange Rate Type Insert Schema
export var insertExchangeRateTypeSchema = createInsertSchema(exchangeRateType).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
...
export var accountGroups = pgTable("account_groups", {
    id: serial("id").primaryKey(),
    code: varchar("code", { length: 10 }).notNull().unique(),
    name: varchar("name", { length: 100 }).notNull(),
    description: text("description"),
...
export var valuationClasses = pgTable("valuation_classes", {
    id: serial("id").primaryKey(),
...
export var valuationClassMaterialTypes = pgTable("valuation_class_material_types", {
    id: serial("id").primaryKey(),
    valuationClassId: integer("valuation_class_id").notNull().references(function () { return valuationClasses.id; }, { onDelete: "cascade" }),
    materialTypeId: integer("material_type_id").notNull().references(function () { return materialTypes.id; }, { onDelete: "cascade" }),
    createdAt: timestamp("created_at").notNull().defaultNow(),
});
// Material Types already exists - using existing table
// Payment Terms - Invoice payment conditions
export var paymentTerms = pgTable("payment_terms", {
    id: serial("id").primaryKey(),
...
export var incoterms = pgTable("incoterms", {
    id: serial("id").primaryKey(),
    code: varchar("code", { length: 10 }).notNull().unique(),
    name: varchar("name", { length: 100 }).notNull(),
    description: text("description"),
...
export var priceLists = pgTable("price_lists", {
    id: serial("id").primaryKey(),
...
export var discountGroups = pgTable("discount_groups", {
    id: serial("id").primaryKey(),
    code: varchar("code", { length: 10 }).notNull().unique(),
    name: varchar("name", { length: 100 }).notNull(),
    description: text("description"),
...
export var creditLimitGroups = pgTable("credit_limit_groups", {
    id: serial("id").primaryKey(),
    code: varchar("code", { length: 10 }).notNull().unique(),
    name: varchar("name", { length: 100 }).notNull(),
    description: text("description"),
...
export var shippingConditions = pgTable("shipping_conditions", {
    id: serial("id").primaryKey(),
    code: varchar("code", { length: 10 }).notNull().unique(),
    name: varchar("name", { length: 100 }).notNull(),
    description: text("description"),
...
export var transportationZones = pgTable("transportation_zones", {
    id: serial("id").primaryKey(),
    code: varchar("code", { length: 10 }).notNull().unique(),
    name: varchar("name", { length: 100 }).notNull(),
    description: text("description"),
...
export var routeSchedules = pgTable("route_schedules", {
    id: serial("id").primaryKey(),
...
export var warehouseTypes = pgTable("warehouse_types", {
    id: serial("id").primaryKey(),
    code: varchar("code", { length: 10 }).notNull(),
    name: varchar("name", { length: 100 }).notNull(),
    plantId: integer("plant_id").notNull().references(function () { return plants.id; }),
    description: text("description"),
...
export var movementTypes = pgTable("movement_types", {
    id: serial("id").primaryKey(),
    code: varchar("code", { length: 10 }).notNull().unique(),
    name: varchar("name", { length: 100 }).notNull(),
    description: text("description"),
...
export var movementClasses = pgTable("movement_classes", {
    id: serial("id").primaryKey(),
...
export var reasonCodes = pgTable("reason_codes", {
    id: serial("id").primaryKey(),
...
export var qualityGrades = pgTable("quality_grades", {
    id: serial("id").primaryKey(),
    code: varchar("code", { length: 10 }).notNull().unique(),
    name: varchar("name", { length: 100 }).notNull(),
    description: text("description"),
...
export var batchClasses = pgTable("batch_classes", {
    id: serial("id").primaryKey(),
    code: varchar("code", { length: 10 }).notNull().unique(),
    name: varchar("name", { length: 100 }).notNull(),
    description: text("description"),
...
export var serialNumberProfiles = pgTable("serial_number_profiles", {
    id: serial("id").primaryKey(),
    code: varchar("code", { length: 20 }).notNull().unique(),
    name: varchar("name", { length: 100 }).notNull(),
    description: text("description"),
...
export var documentCategories = pgTable("document_categories", {
    id: serial("id").primaryKey(),
    code: varchar("code", { length: 20 }).notNull().unique(),
    name: varchar("name", { length: 100 }).notNull(),
    description: varchar("description", { length: 255 }),
...
export var documentTypes = pgTable("document_types", {
    id: serial("id").primaryKey(),
...
export var numberRanges = pgTable("number_ranges", {
    id: serial("id").primaryKey(),
...
export var insertAccountGroupsSchema = createInsertSchema(accountGroups).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
// Reconciliation Accounts schema and types moved to shared/reconciliation-accounts-schema.ts
export var insertValuationClassesSchema = createInsertSchema(valuationClasses).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
// MaterialTypes insert schema already exists above
export var insertPaymentTermsSchema = createInsertSchema(paymentTerms).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertIncotermsSchema = createInsertSchema(incoterms).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertPriceListsSchema = createInsertSchema(priceLists).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertDiscountGroupsSchema = createInsertSchema(discountGroups).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertCreditLimitGroupsSchema = createInsertSchema(creditLimitGroups).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertShippingConditionsSchema = createInsertSchema(shippingConditions).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertTransportationZonesSchema = createInsertSchema(transportationZones).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertRouteSchedulesSchema = createInsertSchema(routeSchedules).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertWarehouseTypesSchema = createInsertSchema(warehouseTypes).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
}).extend({
...
export var insertMovementTypesSchema = createInsertSchema(movementTypes).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertReasonCodesSchema = createInsertSchema(reasonCodes).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertQualityGradesSchema = createInsertSchema(qualityGrades).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertBatchClassesSchema = createInsertSchema(batchClasses).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertSerialNumberProfilesSchema = createInsertSchema(serialNumberProfiles).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertDocumentCategoriesSchema = createInsertSchema(documentCategories).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertDocumentTypesSchema = createInsertSchema(documentTypes).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertNumberRangesSchema = createInsertSchema(numberRanges).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
...
export var salesOrderItems = pgTable("sales_order_items", {
    id: serial("id").primaryKey(),
...
export var orderConditions = pgTable("order_conditions", {
    id: serial("id").primaryKey(),
    salesOrderId: integer("sales_order_id").notNull(),
...
export var transferOrders = pgTable("transfer_orders", {
    id: serial("id").primaryKey(),
...
export var transferOrderItems = pgTable("transfer_order_items", {
    id: serial("id").primaryKey(),
...
// Delivery Documents
export var deliveryDocuments = pgTable("delivery_documents", {
    id: serial("id").primaryKey(),
...
// Delivery Items
export var deliveryItems = pgTable("delivery_items", {
    id: serial("id").primaryKey(),
...
export var billingDocuments = pgTable("billing_documents", {
    id: serial("id").primaryKey(),
...
// Billing Items
export var billingItems = pgTable("billing_items", {
    id: serial("id").primaryKey(),
...
export var documentFlow = pgTable("document_flow", {
    id: serial("id").primaryKey(),
...
// ===================================================================
export var salesOrderItemsRelations = relations(salesOrderItems, function (_a) {
    var one = _a.one, many = _a.many;
    return ({
...
export var orderConditionsRelations = relations(orderConditions, function (_a) {
    var one = _a.one;
    return ({
...
export var transferOrdersRelations = relations(transferOrders, function (_a) {
    var many = _a.many;
    return ({
        items: many(transferOrderItems),
    });
});
export var transferOrderItemsRelations = relations(transferOrderItems, function (_a) {
    var one = _a.one;
    return ({
...
export var deliveryDocumentsRelations = relations(deliveryDocuments, function (_a) {
    var one = _a.one, many = _a.many;
    return ({
...
export var deliveryItemsRelations = relations(deliveryItems, function (_a) {
    var one = _a.one;
    return ({
...
export var billingDocumentsRelations = relations(billingDocuments, function (_a) {
    var one = _a.one, many = _a.many;
    return ({
        deliveryDocument: one(deliveryDocuments, {
...
export var billingItemsRelations = relations(billingItems, function (_a) {
    var one = _a.one;
    return ({
...
// ===================================================================
export var insertSalesOrderItemsSchema = createInsertSchema(salesOrderItems).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertOrderConditionsSchema = createInsertSchema(orderConditions).omit({
    id: true,
    createdAt: true,
});
export var insertTransferOrdersSchema = createInsertSchema(transferOrders).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertTransferOrderItemsSchema = createInsertSchema(transferOrderItems).omit({
    id: true,
    createdAt: true,
});
export var insertDeliveryDocumentsSchema = createInsertSchema(deliveryDocuments).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertDeliveryItemsSchema = createInsertSchema(deliveryItems).omit({
    id: true,
    createdAt: true,
});
export var insertBillingDocumentsSchema = createInsertSchema(billingDocuments).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertBillingItemsSchema = createInsertSchema(billingItems).omit({
    id: true,
    createdAt: true,
});
export var insertDocumentFlowSchema = createInsertSchema(documentFlow).omit({
    id: true,
    createdAt: true,
});
// ===================================================================
...
export var creditRiskAssessments = pgTable("credit_risk_assessments", {
    id: serial("id").primaryKey(),
    customerId: integer("customer_id").notNull(),
...
export var creditDecisions = pgTable("credit_decisions", {
    id: serial("id").primaryKey(),
    customerId: integer("customer_id").notNull(),
    salesOrderId: integer("sales_order_id"),
...
// Dunning Management
export var dunningProcedures = pgTable("dunning_procedures", {
    id: serial("id").primaryKey(),
...
// Dunning History
export var dunningHistory = pgTable("dunning_history", {
    id: serial("id").primaryKey(),
    customerId: integer("customer_id").notNull(),
...
// Cash Application
export var cashApplications = pgTable("cash_applications", {
    id: serial("id").primaryKey(),
...
export var cashApplicationItems = pgTable("cash_application_items", {
    id: serial("id").primaryKey(),
...
export var advancedGlPostings = pgTable("advanced_gl_postings", {
    id: serial("id").primaryKey(),
    documentType: varchar("document_type", { length: 20 }).notNull(),
    documentNumber: varchar("document_number", { length: 20 }).notNull(),
    sourceDocumentId: integer("source_document_id").notNull(),
...
export var advancedGlLineItems = pgTable("advanced_gl_line_items", {
    id: serial("id").primaryKey(),
...
// ===================================================================
export var sdClientConfigurations = pgTable("sd_client_configurations", {
    id: serial("id").primaryKey(),
...
export var sdCustomizationLog = pgTable("sd_customization_log", {
    id: serial("id").primaryKey(),
...
export var sdConfigurationTemplates = pgTable("sd_configuration_templates", {
    id: serial("id").primaryKey(),
...
export var insertSdClientConfigurationsSchema = createInsertSchema(sdClientConfigurations).omit({
    id: true,
    createdDate: true,
    lastModified: true,
});
export var insertSdCustomizationLogSchema = createInsertSchema(sdCustomizationLog).omit({
    id: true,
    timestamp: true,
});
export var insertSdConfigurationTemplatesSchema = createInsertSchema(sdConfigurationTemplates).omit({
    id: true,
    createdDate: true,
});
// ===================================================================
...
// ===================================================================
export var creditRiskAssessmentsRelations = relations(creditRiskAssessments, function (_a) {
    var one = _a.one;
    return ({
        customer: one(customers, {
...
export var creditDecisionsRelations = relations(creditDecisions, function (_a) {
    var one = _a.one;
    return ({
        customer: one(customers, {
...
export var dunningHistoryRelations = relations(dunningHistory, function (_a) {
    var one = _a.one;
    return ({
        customer: one(customers, {
...
export var cashApplicationsRelations = relations(cashApplications, function (_a) {
    var one = _a.one, many = _a.many;
    return ({
        customer: one(customers, {
...
export var cashApplicationItemsRelations = relations(cashApplicationItems, function (_a) {
    var one = _a.one;
    return ({
...
export var advancedGlPostingsRelations = relations(advancedGlPostings, function (_a) {
    var many = _a.many;
    return ({
...
export var enterpriseTransactionRegistry = pgTable("enterprise_transaction_registry", {
    id: serial("id").primaryKey(),
...
export var materialMovementRegistry = pgTable("material_movement_registry", {
    id: serial("id").primaryKey(),
...
export var enterpriseTransactionRegistryRelations = relations(enterpriseTransactionRegistry, function (_a) {
    var one = _a.one;
    return ({
        customer: one(customers, {
...
export var materialMovementRegistryRelations = relations(materialMovementRegistry, function (_a) {
    var one = _a.one;
    return ({
        customer: one(customers, {
...
export var insertEnterpriseTransactionRegistrySchema = createInsertSchema(enterpriseTransactionRegistry).omit({
    id: true,
    createdTimestamp: true,
});
export var insertMaterialMovementRegistrySchema = createInsertSchema(materialMovementRegistry).omit({
    id: true,
    createdTimestamp: true,
});
export var advancedGlLineItemsRelations = relations(advancedGlLineItems, function (_a) {
    var one = _a.one;
    return ({
...
// ===================================================================
export var insertCreditRiskAssessmentsSchema = createInsertSchema(creditRiskAssessments).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertCreditDecisionsSchema = createInsertSchema(creditDecisions).omit({
    id: true,
    createdAt: true,
});
export var insertDunningProceduresSchema = createInsertSchema(dunningProcedures).omit({
    id: true,
    createdAt: true,
});
export var insertDunningHistorySchema = createInsertSchema(dunningHistory).omit({
    id: true,
    createdAt: true,
});
export var insertCashApplicationsSchema = createInsertSchema(cashApplications).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertCashApplicationItemsSchema = createInsertSchema(cashApplicationItems).omit({
    id: true,
    createdAt: true,
});
export var insertAdvancedGlPostingsSchema = createInsertSchema(advancedGlPostings).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertAdvancedGlLineItemsSchema = createInsertSchema(advancedGlLineItems).omit({
    id: true,
    createdAt: true,
});
// ===================================================================
...
export var plannedOrders = pgTable("planned_orders", {
    id: serial("id").primaryKey(),
...
export var purchaseRequisitions = pgTable("purchase_requisitions", {
    id: serial("id").primaryKey(),
...
export var prDocumentTypes = pgTable("pr_document_types", {
    id: serial("id").primaryKey(),
    code: varchar("code", { length: 10 }).notNull().unique(),
    name: varchar("name", { length: 100 }).notNull(),
    description: text("description"),
...
export var purchaseRequisitionItems = pgTable("purchase_requisition_items", {
    id: serial("id").primaryKey(),
    requisitionId: integer("requisition_id").notNull().references(function () { return purchaseRequisitions.id; }),
...
export var mrpAreas = pgTable("mrp_areas", {
    id: serial("id").primaryKey(),
    plantId: integer("plant_id").notNull(),
...
export var mrpRuns = pgTable("mrp_runs", {
    id: serial("id").primaryKey(),
...
export var productionPlanningScenarios = pgTable("production_planning_scenarios", {
    id: serial("id").primaryKey(),
...
//   }),
// }));
export var productionPlanningScenarioRelations = relations(productionPlanningScenarios, function (_a) {
    var many = _a.many;
    return ({
...
// ===================================================================
export var insertPlannedOrderSchema = createInsertSchema(plannedOrders).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertPurchaseRequisitionSchema = createInsertSchema(purchaseRequisitions).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertPurchaseRequisitionItemSchema = createInsertSchema(purchaseRequisitionItems).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
// Purchase Requisition Document Type schemas
export var insertPRDocumentTypeSchema = createInsertSchema(prDocumentTypes).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertMrpAreaSchema = createInsertSchema(mrpAreas).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertMrpRunSchema = createInsertSchema(mrpRuns).omit({
    id: true,
    createdAt: true,
});
export var insertProductionPlanningScenarioSchema = createInsertSchema(productionPlanningScenarios).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
...
export var insertApiKeySchema = createInsertSchema(apiKeys);
// ===================================================================
// ROUTING MASTER DATA TABLES
// ===================================================================
// Routing Master (Header Information)
export var routingMaster = pgTable("routing_master", {
    id: serial("id").primaryKey(),
    materialId: integer("material_id"),
...
export var routingOperations = pgTable("routing_operations", {
    id: serial("id").primaryKey(),
    routingMasterId: integer("routing_master_id").notNull().references(function () { return routingMaster.id; }, { onDelete: "cascade" }),
...
export var routingOperationComponents = pgTable("routing_operation_components", {
    id: serial("id").primaryKey(),
    routingOperationId: integer("routing_operation_id").notNull().references(function () { return routingOperations.id; }, { onDelete: "cascade" }),
    materialId: integer("material_id"),
    materialCode: varchar("material_code", { length: 100 }).notNull(),
...
// Routing Relations
export var routingMasterRelations = relations(routingMaster, function (_a) {
    var many = _a.many;
    return ({
        operations: many(routingOperations),
    });
});
export var routingOperationsRelations = relations(routingOperations, function (_a) {
    var one = _a.one, many = _a.many;
    return ({
...
export var routingOperationComponentsRelations = relations(routingOperationComponents, function (_a) {
    var one = _a.one;
    return ({
...
// Zod schemas
export var insertRoutingMasterSchema = createInsertSchema(routingMaster);
export var insertRoutingOperationSchema = createInsertSchema(routingOperations);
export var insertRoutingOperationComponentSchema = createInsertSchema(routingOperationComponents);

-- Update reason codes table to match new requirements
-- This migration updates the reason codes table structure for sales document integration

-- First, backup existing data if any
CREATE TABLE IF NOT EXISTS reason_codes_backup AS SELECT * FROM reason_codes;

-- Drop existing table and recreate with new structure
DROP TABLE IF EXISTS reason_codes CASCADE;

-- Create new reason codes table with proper structure
...
CREATE INDEX idx_reason_codes_category ON reason_codes(reason_category_key);

...
async function createTransportationZonesTable() {
  const client = await pool.connect();
  try {
    console.log('Creating transportation_zones table with all standard fields...');
    const sql = readFileSync(
      join(__dirname, '../database/migrations/create-transportation-zones-table.sql'),
      'utf8'
    );
    ...
    console.log('\n✅ Successfully created transportation_zones table!');
...
createTransportationZonesTable();
